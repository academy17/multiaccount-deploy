...
import type {
  SymmioPartyA,
  SymmioPartyAInterface,
} from "../../../contracts/multiAccount/SymmioPartyA";
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "oldV3ContractAddress",
        type: "address",
      },
      {
        indexed: false,
        internalType: "address",
        name: "newV3ContractAddress",
        type: "address",
      },
    ],
...
type SymmioPartyAConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SymmioPartyAConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SymmioPartyA__factory extends ContractFactory {
  constructor(...args: SymmioPartyAConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override deploy(
    ...
    multiAccountAddress: PromiseOrValue<string>,
    symmioAddress_: PromiseOrValue<string>,
    overrides?: Overrides & { from?: PromiseOrValue<string> }
  ): Promise<SymmioPartyA> {
    return super.deploy(
      admin,
      multiAccountAddress,
      symmioAddress_,
      overrides || {}
    ) as Promise<SymmioPartyA>;
  }
  ...
  override attach(address: string): SymmioPartyA {
    return super.attach(address) as SymmioPartyA;
  }
  override connect(signer: Signer): SymmioPartyA__factory {
    return super.connect(signer) as SymmioPartyA__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SymmioPartyAInterface {
    return new utils.Interface(_abi) as SymmioPartyAInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SymmioPartyA {
    return new Contract(address, _abi, signerOrProvider) as SymmioPartyA;
  }
}
