...
export interface SymmioPartyAInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "MULTIACCOUNT_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "MULTIACCOUNT_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SetSymmioAddressEventObject {
  oldV3ContractAddress: string;
  newV3ContractAddress: string;
}
...
export interface SymmioPartyA extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SymmioPartyAInterface;
  ...
  functions: {
    ...
    MULTIACCOUNT_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "SetSymmioAddress(address,address)"(
      oldV3ContractAddress?: null,
      newV3ContractAddress?: null
  ...
  estimateGas: {
    ...
    MULTIACCOUNT_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    MULTIACCOUNT_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
